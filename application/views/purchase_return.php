   ...
   <div id="data-list">
    ...
    <div id="data-form" style="display:none;">
		...
		<div class="form-group">
			...
			<div class="col-sm-3">
				<input type="text" tabindex="3" name="ledger_mobno" id="ledger_mobno" class="col-xs-10 col-sm-12" placeholder="Vehicle No."/>
			</div>
		</div>
		<div class="form-group">
			...
			<div class="col-sm-3">
			    <select name="item_type" id="item_type" class="col-xs-10 col-sm-12" tabindex="4">
		...
		<table id="TblRpt" class="table">
		 ...
		 <tbody id="TblRptBody">
		  <tr>
           ...
           <td style="width:150px;"><input tabindex="8" type="text" name="freight[]" id="txt_freight" class="freight txt_cls" readonly="true" onblur="TolFreight();" /></td>
           <td><button tabindex="9" type="button" id="btn_add" class="btn btn-xs btn-info" onclick="ItemAddNew(this);return false;"><i class="ace-icon fa fa-plus bigger-120"></i></button><button type="button" id="btn_add" class="btn btn-xs btn-danger" onclick="deleteRow(this);return false;"><i class="ace-icon fa fa-trash-o bigger-120"></i></button></td>
		  </tr>
		 </tbody>
		 <tfoot>	
		  <tr>
		...
		<div class="form-group">
			...
			<div class="col-sm-10">
				<input type="text" tabindex="10" name="remark" id="remark" placeholder="Remark" class="col-xs-11"/><!-- col-xs-10 col-sm-12 -->
			</div>			
		</div>
		<div class="form-group">
		...
		<script type="text/javascript">
            ...
            function GetFreight(id){
 		    ...
 		    function GetList() {
		        ...
		        $(".loading").show();
		        $.ajax({
		            url: "<?php echo base_url();?>index.php/transactionController/purchase_return_list",
		            type: "GET",
		    ...
		    function GetItemList(ID) {
		        ...
		        $(".loading").show();
		        $.ajax({
		            url: "<?php echo base_url();?>index.php/transactionController/purchase_return_get_item",
		            type: "GET",
...
//		                $('#TblRpt tbody').append(html);
           ...
           //      });
		        ...
		        if(company_id=='' || company_id==0){
                   alert('Unexpected Error ! Login Again .');
		        	...
		        	//  if(rowCount>1){
		                ...
		                $.ajax({
		                    url: "<?php echo base_url();?>index.php/transactionController/purchase_return_save",
		                    type: "POST",
		    ...
		    function GetRecord(ID) {
		        var url = "<?php echo base_url();?>index.php/transactionController/purchase_return_get?id=" + ID;
		        $.get(url, function (data) {
		            var report_obj = JSON.parse(data);
		            if (report_obj.Message == "Success") {
