    <div id="data-form">
	    ...
	    <div class="widget-header">
		    <h4 class="widget-title">Ledger Mobile No.</h4>
	    </div>
  ...
  function hidebtn() {
		    ...
		    function GetList() {
		        ...
		        addLoading();
		        $.ajax({
		            url: "<?php echo base_url();?>index.php/master_general/ledger_mobile",
		            type: "GET",
		            data: data,
		            cache: false,
		            success: function (html) {
				        ...
				        $('#newsubmit').click(function () {
				                ...
				                $('.loading').show();
				                $.ajax({
				                    url: "<?php echo base_url();?>index.php/master_general/ledger_mobile_save",
				                    type: "POST",
				                    data: data,
				                    cache: false,
				                    success: function (html) {
