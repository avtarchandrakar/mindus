...
//                    $("[tabindex='1']").focus();
            ...
            function GetRpt() {
                ...
                $.ajax({
                    url: "<?php echo base_url();?>index.php/transactionController/voucher_rpt",
                    type: "GET",
                    data: data, 
                    cache: false,
...
//                        $('#from').select();
            ...
            function ShowPrint(){
                ...
                window.open($('#baseurl').val()+'index.php/transactionController/voucher_rpt_print/'+from+'/'+to+'/'+vtype,'_blank');
            }
            //M-1 :
                function GetParty(){
