...
<div class="modal fade" id="modal_form" role="dialog">
    ...
    <div id="data-form2" style="display:none;">
        ...
        <div class="widget-header"> 
            <h4 class="widget-title">Daily Report</h4>
        </div>
        ...
        <table class="table">
         <tr>
          <td>From</td><td><input tabindex="101" type="text"  name="from" id="from" placeholder="From" class="cdate col-xs-6 col-sm-6" list="0"/></td>
          <td>To</td><td><input tabindex="102" type="text"  name="to" id="to" placeholder="To" class="cdate col-xs-6 col-sm-6" list="0"/></td>
          <td><button tabindex="103" type="button" id="btn_show" class="btn btn-primary" onclick="GetRpt();">Show</button></td>
          <td>
          <?php if($p_delete==1){ ?>
        ...
        <div class="clearfix form-actions hidden">
            <div class="col-md-offset-3 col-md-9">
                <button  tabindex="104" class="btn btn-info" type="button" id="newsubmit" >
...
//                    $("[tabindex='1']").focus();
            ...
            function GetRpt() {
                ...
                $(".loading").show();
                $.ajax({
                    url: "<?php echo base_url();?>index.php/transactionController/daily_report_checking",
                    type: "GET",
                    data: data,
                    cache: false,
...
//                        $('#from').focus();
            ...
            function ShowPrint(){
                from=$('#from').val();
                to=$('#to').val();
                window.open($('#baseurl').val()+'index.php/transactionController/daily_report_check_print/'+from+'/'+to,'_blank');
            }
            //M-1 :
                function GetParty(){
