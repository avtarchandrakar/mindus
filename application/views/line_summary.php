...
?>
    ...
    <div id="data-form2" style="display:none;">
        ...
        <div class="widget-header"> 
            <h4 class="widget-title">Line Summary</h4>
        </div>
         ...
         <tr>
          ...
          <td style="width:300px;">
                <?php
                  ...
                  echo "<select id='line_id' name='line_id' tabindex='2' class='col-xs-10 col-sm-12' data-placeholder='Select Group Name...''>";
...
//                    $("[tabindex='1']").focus();
            ...
            function GetRpt() {
                ...
                $(".loading").show();
                $.ajax({
                    url: "<?php echo base_url();?>index.php/transactionController/line_summary",
                    type: "GET",
                    data: data,
                    cache: false,
...
//                        $('#to').focus();
            ...
            function ShowPrint(){
                to=$('#to').val();
                line_id=$('#line_id').val();
                window.open($('#baseurl').val()+'index.php/transactionController/line_summary_print/'+to+'/'+line_id,'_blank');
            }
            //M-1 :
                function GetParty(){
