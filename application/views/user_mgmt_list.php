      ...
      <div class="modal-dialog">
        <div class="modal-content">
            	...
            	<table style="width:500px;">
            		<tr>
            			...
            			<td style="width:300px;">
							<input type="text"  name="username3" id="username3" class="col-xs-10 col-sm-12" />
            		...
            		<tr>
            			...
            			<td style="width:300px;">
							<input type="password"  name="password3" id="password3" class="col-xs-10 col-sm-12" />
            			</td>
            		</tr>
            	</table>
          ...
          <div class="modal-footer">
            ...
            <button type="button" id="pass_save" class="btn btn-primary">Save changes</button>
          </div>
        </div><!-- /.modal-content -->
      </div><!-- /.modal-dialog -->
    </div><!-- /.modal -->
    ...
    <div id="data-form" style="display:none;">
		...
		<div class="form-group">
			...
			<div class="col-sm-3">
				<select tabindex="2" name="back_date" id="back_date" data-rule-required="true"  class="col-xs-10 col-sm-12">
		...
		<div class="form-group">
			...
			<div class="col-sm-3">
				<input tabindex="3" type="text"  name="ip_address" id="ip_address" placeholder="IP Address" class="col-xs-10 col-sm-12" />
			</div>
		</div>
		...
		<div class="form-group">
			...
			<div class="col-sm-3">
				<input tabindex="4" type="text"  name="mobile1" id="mobile1" placeholder="Mobile No." class="col-xs-10 col-sm-12" />
			</div>
		</div>
		...
		<div class="form-group">
			...
			<div class="col-sm-3">
				<input tabindex="5" type="text"  name="mobile2" id="mobile2" placeholder="Mobile No." class="col-xs-10 col-sm-12" />
			</div>
		</div>
		...
		<div class="form-group">
			...
			<div class="col-sm-3">
				<input tabindex="6" type="text"  name="mobile3" id="mobile3" placeholder="Mobile No." class="col-xs-10 col-sm-12" />
			</div>
		</div>
		...
		<div class="form-group">
			...
			<div class="col-sm-3">
				<input tabindex="7" type="text"  name="otp" id="otp" placeholder="OTP" class="col-xs-10 col-sm-12" />
			</div>
		</div>
		...
		<div class="form-group">
			...
			<div class="col-sm-10 multi_inst">
                     <select  tabindex="8" multiple="multiple" size="10" name="listbox[]" class='demo2 col-md-6' >
		...
		<script type="text/javascript">
		    ...
		    function GetList() {
		        ...
		        $(".loading").show();
		        $.ajax({
		            url: "<?php echo base_url();?>index.php/master_general/user_list",
		            type: "GET",
		            data: data,
		            cache: false,
		           ...
		           if($("#password3").val()=="")
		           	{
		                ...
		                var data = "userid="+$("#userid3").val()+"&password="+$("#password3").val();
		                $('.loading').show();
		                $.ajax({
		                    url: "<?php echo base_url();?>index.php/master_general/user_password",
		                    type: "POST",
		                    data: data,
		                    cache: false,
		                    success: function (html) {
		                        ...
		                        if (html == 1) {
					                $('.modal').modal('hide');
		                            $("html, body").animate({ scrollTop: 0 }, "slow");
		                            $('.done').html("<h4>Password Changed.</h4>");
		                            $('.done').fadeIn('slow', function () { });
		                            $('.done').delay(600).fadeOut('slow', function () { });
		                        } else {
		                                alert('Sorry, unexpected error. Please try again later.');
...
//		                $("#openpass").val(report_obj.openpass);
		    ...
		    function GetPassword(ID,param) {
            	cRow=$(param).parent().parent().parent();
				$("#username3").val(($(cRow).find('.username_1').html()));
				$("#userid3").val(ID);
                $('.modal').modal('show');
		    }
		    ...
		    function DeleteRecord(ID) {
		        ...
		        if (r == true) {
		            $('.loading').show();
		                $.ajax({
		                    url: "<?php echo base_url();?>index.php/helperController/delete/m_user/id",
		                    type: "POST",
		                    data: {ID: ID},
		                    cache: false,
		                    success: function (html) {
