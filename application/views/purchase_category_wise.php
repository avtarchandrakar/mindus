...
?>
    ...
    <div id="data-form2" style="display:none;">
        ...
        <div class="widget-header"> 
            <h4 class="widget-title">Purchase Category Wise</h4>
        </div>
...
//                    $("[tabindex='1']").focus();
            ...
            function GetRpt() {
                ...
                $(".loading").show();
                $.ajax({
                    url: "<?php echo base_url();?>index.php/transactionController/purchase_category_wise",
                    type: "GET",
                    data: data,
                    cache: false,
...
//                        $('#from').focus();
            ...
            function ShowPrint(){
                ...
                to=$('#to').val();
                ledger_id=$('#ledger_id').val();
                window.open($('#baseurl').val()+'index.php/transactionController/purchase_category_wise_print/'+from+'/'+to+'/'+ledger_id,'_blank');
            }
            //M-1 :
                function GetParty(){
...
//                $('#from').focus();
              ...
              function exportExcel(){
                $("#TblList").table2excel({
                    // exclude CSS class
                    exclude: ".noExl",
                    name: "Purchase Category Wise",
                    filename:"Purchase Category Wise"
                  });    
