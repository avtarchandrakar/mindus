   <div id="data-list">
    ...
    <div id="data-form" style="display:none;">
	    ...
	    <div class="widget-header">
		    <h4 class="widget-title">Manage Item Group</h4>
	    </div>
		...
		<div class="form-group">
			...
			<label class="col-sm-2 control-label no-padding-right" for="form-field-1"> Packing</label>

			<div class="col-sm-3">
				<input tabindex="2" type="text"  name="vat" id="vat"   placeholder="Packing" class="col-xs-10 col-sm-12" />
			</div>
		</div>
		...
		<script type="text/javascript">
		    ...
		    function GetList() {
		        ...
		        $(".loading").show();
		        $.ajax({
		            url: "<?php echo base_url();?>index.php/master_general/itemgroup_list",
		            type: "GET",
		            data: data,
		            cache: false,
		    ...
		    $(document).ready(function () {
		        ...
		        $('#newsubmit').click(function () {
		            ...
		            if ($("#userform").valid() == true) {
		                ...
		                $('.loading').show();
		                $.ajax({
		                    url: "<?php echo base_url();?>index.php/helperController/m_itemgroup/m_master/id",
		                    type: "POST",
		                    data: data+'&type=Item Group',
		                    cache: false,
		                    success: function (html) {
		                        $('.loading').hide();
		                        if (html == 1) {
		    ...
		    function GetRecord(ID) {
		        var url = "<?php echo base_url();?>index.php/master_general/itemgroup_get?id=" + ID;
