    ...
    <div id="data-form" style="display:none;">
		...
		<div class="form-group">
			...
			<div class="col-sm-3">
				<input type="text" name="country_code" id="country_code" value="+91" required placeholder="+91" class="col-xs-2 col-sm-2" /><input type="text" minlength="10" maxlength="10" name="mobileno" id="mobileno" placeholder="Mobile No." class="col-xs-8 col-sm-10" />
			</div>

			<label class="col-sm-2 control-label no-padding-right" for="form-field-1"> Mobile No. 2</label>

			<div class="col-sm-3">
				<input type="number" name="country_code2" id="country_code2" value="+91" placeholder="+91" class="col-xs-2 col-sm-2" /><input type="text" name="mobileno2" minlength="10" id="mobileno2" maxlength="10"   placeholder="Mobile No." class="col-xs-8 col-sm-10" />
			</div>
		...
		<script type="text/javascript">
		    ...
		    function GetList() {
		        ...
		        $(".loading").show();
		        $.ajax({
		            url: "<?php echo base_url();?>index.php/master_general/supplayer_list",
		            type: "GET",
		            data: data,
		            cache: false,
		    ...
		    $(document).ready(function () {
		        ...
		        $('#newsubmit').click(function () {
		            ...
		            if ($("#userform").valid() == true) {
		                ...
		                $('.loading').show();
		                $.ajax({
		                    url: "<?php echo base_url();?>index.php/helperController/m_insert1/m_ledger/id",
		                    type: "POST",
		                    data: data,
		                    cache: false,
		                    success: function (html) {
