            ...
            <td style="border:2px solid green;">
              <table border="0" style="width:100%;" cellpadding="0" cellspacing="0">
                <tr>
                  ...
                  <td style="width:33%;text-align:center;font-size:14px;font-weight:bold;">
                    QUOTATION
                  </td>
            ...
            <td style="width:100%;" >
              <table border="0" style="width:100%;" cellpadding="0" cellspacing="0">
                <tr style="display: none;">
                  <td style="width:50%;text-align:left;font-size:14px;font-weight: bold;">
                     <?php echo $quatation_no;?>
                  </td>
                  <td style="width:50%;text-align:right;font-size:14px;font-weight: bold;">
                    Date : <?php echo date('d-m-Y',strtotime($row->cdate));?>
                  </td>
                </tr>
                <tr>
                  <td style="width:60%;text-align:left;font-size:14px;font-weight: bold;">
                    <i>To</i>,
                  </td>
                  <td style="width:40%;text-align:left;font-size:13px;font-weight: bold;">
                ...
                <?php if ($header!='') { ?>
                <tr>
                  <td colspan="2" style="width:100%;text-align:left;font-size:13px;text-align: justify;text-justify: inter-word;">
          ...
          <tr>
            <td style="width:100%;">
              <table style="width:100%;" cellpadding="0" cellspacing="0">
                ...
                <thead>
                <tr>
                  <td colspan="5" style="border-left: 1px solid;border-right: 1px solid;border-top:1px solid black;width:100%;text-align:center;font-size:13px;font-weight: bold;">
                    Technical Specification of ANFO Unit
                  </td>
                </tr>
                <tr>
                  <td style="border-left: 1px solid;border-top:1px solid black;border-bottom:1px solid black;width:5%;text-align:center;font-size:13px;">
                    Sr. No.
                  </td>
                  <td style="border-top:1px solid black;border-left:1px solid;border-bottom:1px solid black;width:10%;text-align:center;font-size:13px;">
                    Item
                  </td>
                  <td style="border-top:1px solid black;border-left:1px solid;border-bottom:1px solid black;width:50%;text-align:center;font-size:13px;">
                    Specification
                  </td>
                  <td style="border-top:1px solid black;border-bottom:1px solid black;border-left:1px solid;width:10%;text-align:center;font-size:13px;">
                    MOC
                  </td>
                  <td style="border-top:1px solid black;border-bottom:1px solid black;border-left:1px solid;width:10%;text-align:center;font-size:13px;border-right: 1px solid;">
                    Quantity
                  </td>
                </tr>
                </thead>
                ...
                <? 
                  ...
                  {?>
                    <tr>
                      <td style="border-bottom:1px solid;border-left: 1px solid;width:5%;text-align:left;font-size:13px;padding:5px;">
                        <?php echo $i+1;?>
                      </td>
                      <td style="border-bottom:1px solid;border-left:1px solid;width:10%;text-align:left;font-size:13px;padding:5px;">
                        <?php echo ucwords(strtolower($row->item));?>
                      </td>   
                      <td style="border-bottom:1px solid;border-left:1px solid;width:50%;text-align:left;font-size:13px;padding:5px;">
                        <?php echo ucwords(strtolower($row->remark));?>
                      </td>    
                      <td style="border-bottom:1px solid;border-left:1px solid;width:10%;text-align:left;font-size:13px;padding:5px;">
                        <?php echo ucwords(strtolower($row->moc));?>
                      </td>                
                      <td style="border-bottom:1px solid;border-left:1px solid;width:10%;text-align:center;font-size:13px;padding:5px;border-right: 1px solid;">
                ...
                <tfoot>
                  <tr>
                  <td colspan="5" style="width:100%;text-align:left;border-top: 0.1px solid grey;">
          ...
          <tr>
            <td style="width:100%;">
              <table style="width:100%; margin-top: 3px;" cellpadding="0" cellspacing="0">
                ...
                <tr>
                  <th style="width:20%;text-align:center;padding:5px;border: 0.1px solid grey;border-bottom:0.1px solid grey ;font-size:15px;margin-top: 30px;">
                    Item
                  </th>
                  <th style="width:80%;text-align:center;padding:5px;border: 0.1px solid grey;border-bottom:0.1px solid grey ;font-size:15px;margin-top: 30px;">
                ...
                <?php if ($price!='0') { ?>
                <tr>
                  <td style="width:30%;text-align:center;padding:5px;border: 0.1px solid grey;border-bottom:0.1px solid grey ;font-size:15px;margin-top: 30px;">
                    <b>Price</b>
                  </td>
                  <td style="width:60%;text-align:center;padding:5px;border: 0.1px solid grey;border-bottom:0.1px solid grey ;font-size:15px;margin-top: 30px;text-align: justify;text-justify: inter-word;">
                ...
                <tr>
                  <td style="width:30%;text-align:center;padding:5px;border: 0.1px solid grey;border-bottom:0.1px solid grey ;font-size:15px;">
                    <b>Performance Warranty</b>
                  </td>
                  <td style="width:60%;text-align:center;padding:5px;border: 0.1px solid grey;border-bottom:0.1px solid grey ;font-size:15px;text-align: justify;text-justify: inter-word;">
                ...
                <tr>
                  ...
                  <td style="width:40%;text-align:center;padding:5px;border: 0.1px solid grey;border-bottom:0.1px solid grey ;font-size:15px;text-align: justify;text-justify: inter-word;">
                ...
                <tr>
                  ...
                  <td style="width:60%;text-align:center;padding:5px;border: 0.1px solid grey;border-bottom:0.1px solid grey ;border-top:0.1px solid grey ;font-size:15px;text-align: justify;text-justify: inter-word;">
                ...
                <?php } ?>
                <tr>
                  <td colspan="1" style="width:70%;text-align:left;padding:5px;border-bottom:0.1px solid grey ;border-left:0.1px solid grey ;font-size:15px;">
                    Warm Regards,<br>
                    Venketeshwar Agrawal<br>
                    Metalite Industries<br>
                    Contact: +91 7052899999<br>
                  </td>
                  <td colspan="1" style="width:30%;padding:5px;border-bottom:0.1px solid grey ;font-size:15px;border-right:0.1px solid grey ;">
                    (signature) <br>For Metalite Industries
                  </td>
                </tr>
                </tbody>
                <tfoot>
                  <tr>
                  <td colspan="3" style="width:100%;text-align:left;border-top: 0.1px solid grey;">
