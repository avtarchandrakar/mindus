...
?>
    ...
    <div id="data-form2" style="display:none;">
        ...
        <div class="widget-header"> 
            <h4 class="widget-title">Ageing Report</h4>
        </div>
        ...
        <table class="table">
         <tr>
          <td>Upto</td><td><input tabindex="1" type="text"  name="to" id="to" placeholder="To" value="<?echo $cdate;?>" class="cdate col-xs-6 col-sm-6" list="0"/></td>
          <td>Line</td>
          <td>
                <select name="line" id="line" class="col-xs-10 col-sm-12" tabindex="2">
                     <option value=" ">Select Line</option>
                     <? $query=$this->db->query('select id,name from m_master where company_id='.get_cookie('ae_company_id').' and type="LINEGROUP" order by name'); ?>           
                     <? if($query->num_rows()>0){ ?>
          ...
          <td>
                <?php
                  ...
                  echo "<select id='group_id' name='group_id' tabindex='7' class='col-xs-10 col-sm-12' data-placeholder='Select Group Name...''>";
          ...
          <td><button tabindex="3" type="button" id="btn_show" class="btn btn-primary" onclick="GetRpt();">Show</button></td>
         </tr>
        </table>
        </div>
...
//                    $("[tabindex='1']").focus();
            ...
            function GetRpt() {
                ...
                data ="to="+to+"&line="+line+"&group_id="+group_id;
                $(".loading").show();
                $.ajax({
                    url: "<?php echo base_url();?>index.php/transactionController/ageing_line",
                    type: "GET",
                    data: data,
                    cache: false,
...
//                        $('#to').focus();
            ...
            function ShowPrint(){
                to=$('#to').val();
                line=$('#line').val();
                window.open($('#baseurl').val()+'index.php/transactionController/ageing_line_print/'+to+'/'+line,'_blank');
            }
            //M-1 :
                function GetParty(){
