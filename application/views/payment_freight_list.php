...
<h4 class="widget-title">Payment Freight List</h4>
</div>
...
<label class="col-sm-2 control-label no-padding-right" for="form-field-1"> Ledger Name</label>
<div class="col-sm-2">
...
$(document).ready(function () {
    ...
    $('#newsubmit').click(function () {
        ...
        if ($("#userform").valid() == true) {
            ...
            $('.loading').show();
            $.ajax({
                url: "<?php echo base_url();?>index.php/transactionController/paymentFreight_list_by_search",
                type: "POST",
                data: data +'&list=list',
                dateType: "html",
                cache: false,
