    ...
    <div id="data-form" style="display:none;">
	    ...
	    <div class="widget-header">
		    <h4 class="widget-title">Manage Item Master Category</h4>
	    </div>
		...
		<div class="form-group">
			<label class="col-sm-2 control-label no-padding-right" for="form-field-1"> CD Applicable</label>

			<div class="col-sm-3">
				<select tabindex="2" name="prefix" id="prefix" data-rule-required="true" class="col-xs-10 col-sm-12">
		...
		<script type="text/javascript">
		    ...
		    function GetList() {
		        ...
		        $(".loading").show();
		        $.ajax({
		            url: "<?php echo base_url();?>index.php/master_general/mastercategory_list",
		            type: "GET",
		            data: data,
		            cache: false,
		        ...
		        $('#newsubmit').click(function () {
		            ...
		            if ($("#userform").valid() == true) {
		                ...
		                $.ajax({
		                    ...
		                    type: "POST",
		                    data: data+'&type=Master Category',
		                    cache: false,
		                    success: function (html) {
		                        $('.loading').hide();
		                        if (html == 1) {
		    ...
		    function GetRecord(ID) {
		        var url = "<?php echo base_url();?>index.php/master_general/mastercategory_get?id=" + ID;
