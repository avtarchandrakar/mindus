...
//			            $('#data-form').fadeIn(500);
		    ...
		    $(document).ready(function () {
 		    ...
 		    function GetList() {
		        ...
		        $(".loading").show();
		        $.ajax({
		            url: "<?php echo base_url();?>index.php/transactionController/approve_list",
		            type: "GET",
		    ...
		    function GetCpoForm(ID,q) {
		    	// $action=$this->input->get('action');
		    	action = 'edit';
		    	id = ID;
				$('#modal_form').modal('show');
		        $.ajax({
		            url: "<?php echo base_url();?>index.php/formController/approval_edit",
		            type: "POST",
		            data: {
		            	action:action,
		            	id:id
		    ...
		    function GetCpoFormadd(ID,sales) {
				$('#modal_form').modal('show');
		        $.ajax({
...
//				    	$('.cdate').val(getCurDate());
		    ...
		    function GetReport(ID) {
	            window.open("<?php echo base_url();?>index.php/transactionController/jobcard_bill_print/"+ID,'_blank');
		    }

		    function GetReport4(ID) {
	            window.open("<?php echo base_url();?>index.php/transactionController/approval_print/"+ID,'_blank');
		    }
