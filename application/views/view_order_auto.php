<?php
	//List :
	// 	Function : transactionController/take_order_list

	//Mail :
	//	Function : transactionController/order_mail
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <p id="alert"></p>
        <lable class="col-sm-3 control-label no-padding-right">Enter Email ID</lable><input type="text" id="emailid" style="text-transform:none;" name="emailid" class="col-xs-8"/>
        <br><br>
      </div>
    ...
    <div id="data-list">
    	<div id="frmFilter" style="display:none;">
    ...
    <button class="btn btn-info" type="button" id="btn_email" data-toggle="modal" data-target="#myModal">
    ...
    <div id="data-form" style="display:none;">
		...
		<script type="text/javascript">
		    ...
		    function GetList() {
		        ...
		        $(".loading").show();
		        $.ajax({
		            url: "<?php echo base_url();?>index.php/transactionController/take_order_list_live",
		            type: "GET",
		            data: data,
		            cache: false,
		    ...
		    function DispatchOrder(orderid_gen)
		    {
		        LoadEditForm('Dispatch','pending',orderid_gen);
		    }

		    function TransferOrder(orderid_gen)
		    {
		        LoadEditForm('Transfer','pending',orderid_gen);
		    }
			...
			//    $('.mytable').tableExport({type:'excel',escape:'false'});
			  ...
			  function exportPDF(){
//				$('#TblList').tableExport({type:'pdf',pdfFontSize:'4',escape:'false',ignoreColumn: [7,8,9,10,11]});

		        data = $("#showform").serialize();
		        data=data+"&list=list";
		        $(".loading").show();
		        $.ajax({
		            url: "<?php echo base_url();?>index.php/transactionController/take_order_list_pdf",
		            type: "GET",
		            data: data,
		            cache: false,
		            success: function (html) {
		                $(".loading").hide();
						window.open($('#baseurl').val()+'PDF/'+html+'.pdf','_blank');
