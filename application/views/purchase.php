...
//				    	$('.cdate').val(getCurDate());
		...
		function GetReport(ID) {
              window.open("<?php echo base_url();?>index.php/transactionController/purchase_bill_print/"+ID,'_blank');
        }
        ...
        function GetDownload(ID) {
		    ...
		    function GetWhatsapp(ID,ledger_id) {
		    	$('#modal_form').modal('show');
		        $.ajax({
		            url: "<?php echo base_url();?>index.php/formController/whatsapp_form_purchase",
		            type: "GET",
		    ...
		    function GetMail(ID,ledger_id) {
			    ...
			    $('#modal_form').modal('show');
		        $.ajax({
		            url: "<?php echo base_url();?>index.php/formController/mail_form_purchase",
		            type: "GET",
			        data: data+'&gid='+ID+'&ledger_id='+ledger_id,
		            cache: false,
		            success: function (html) {
