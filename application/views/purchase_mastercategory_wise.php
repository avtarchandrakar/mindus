...
?>
    ...
    <div id="data-form2" style="display:none;">
        ...
        <div class="widget-header"> 
            <h4 class="widget-title">Purchase Master Category Wise</h4>
        </div>
...
//                    $("[tabindex='1']").focus();
            ...
            function GetRpt() {
                ...
                $(".loading").show();
                $.ajax({
                    url: "<?php echo base_url();?>index.php/transactionController/purchase_mastercategory_wise",
                    type: "GET",
                    data: data,
                    cache: false,
...
//                $('#from').focus();
              ...
              function exportExcel(){
                $("#TblList").table2excel({
                    // exclude CSS class
                    exclude: ".noExl",
                    name: "Purchase Master Category Wise",
                    filename:"Purchase Master Category Wise"
                  });    
            ...
            function ShowPrint()
            {
                ...
                to=$('#to').val();
                ledger_id=$('#ledger_id').val();
                window.open($('#baseurl').val()+'index.php/transactionController/purchase_master_wise_print/'+from+'/'+to+'/'+ledger_id,'_blank');
            }
