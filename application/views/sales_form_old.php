   ...
   .modal-dialog{
	...
	<div id="data-form">
		...
		<div class="form-group">
			...
			<div class="col-sm-3">
				<input tabindex="2" type="text"  name="lname" id="lname" autocomplete="off" placeholder="Client/Customer Name" class="ledgerinfo col-xs-10 col-sm-12" list="0" onkeyup="GetParty();return false;" /><input type="hidden" id="ledger_id" name="ledger_id">
			</div>
		...
		<div class="form-group">
			...
			<div class="col-sm-10">
				<textarea tabindex="4" type="text"  name="ref_details" id="ref_details" autocomplete="off"  placeholder="Ref:" class=" col-xs-10 col-sm-12" list="0"></textarea>
			</div>
		</div>
		<div class="form-group">
			...
			<div class="col-sm-10">
				<textarea tabindex="5" type="text"  name="sub_details" id="sub_details" autocomplete="off" placeholder="Sub:" class=" col-xs-10 col-sm-12" list="0"></textarea>
			</div>
		</div>
		<div class="form-group">
			...
			<div class="col-sm-10">
				<input tabindex="6" type="text"  name="kindattn" id="kindattn" autocomplete="off" placeholder="Kind Attn" class=" col-xs-10 col-sm-12" list="0"/>
			</div>
		</div>
		<div class="form-group" >
			...
			<div class="col-sm-2">
					<select name="semi_formal" tabindex="7" id="semi_formal" class="col-xs-10 col-sm-12">
		...
		<div class="form-group">
			...
			<div class="col-sm-10">
				<textarea  type="text" tabindex="8" name="scope_of_work" id="scope_of_work" autocomplete="off" placeholder="Sub:" class=" col-xs-10 col-sm-12" list="0"><?php echo $custome_list[0]->scope_of_work?></textarea>
			</div>
		</div>
		<div class="form-group">
			...
			<div class="col-sm-10">
				<textarea tabindex="9" type="text"  name="header" id="header" autocomplete="off" placeholder="Sub:" class=" col-xs-10 col-sm-12" list="0"><?php echo $custome_list[0]->header?></textarea>
			</div>
		</div>
                    ...
                    $('#userform').ajaxSubmit({url:target,
                            ...
                            success: function (html) 
                            {
		                        ...
		                        if (html > 0) 
		                        {
									...
									if(r==true)
									{
						                window.open("<?php echo base_url();?>index.php/transactionController/q2_bill_print/"+html,'_blank');
									}	
		                            if (status.val() == "edit") {
