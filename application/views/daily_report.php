...
//                    $("[tabindex='1']").focus();
            ...
            function GetRpt() {
                ...
                $(".loading").show();
                $.ajax({
                    url: "<?php echo base_url();?>index.php/transactionController/daily_report",
                    type: "GET",
                    data: data,
                    cache: false,
...
//                        $('#from').focus();
            ...
            function ShowPrint(){
                from=$('#from').val();
                to=$('#to').val();
                window.open($('#baseurl').val()+'index.php/transactionController/daily_report_print/'+from+'/'+to,'_blank');
            }
            //M-1 :
                function GetParty(){
