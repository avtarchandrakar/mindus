    ...
    <div id="data-form2" style="display:none;">
        ...
        <div class="widget-header"> 
            <h4 class="widget-title">Rate Difference</h4>
        </div>
        ...
        <?
            $sql = "SELECT t1.id,t1.cdate,t1.builtyno,l.name as ledgername,t1.vtype,i.name,t2.qtymt,t2.rate,t2.itemcode,i.group_id,(select rate from m_rate where item_id=i.group_id order by pdate desc limit 0,1) as pricerate FROM tbl_trans1 t1, m_ledger l,tbl_trans2 t2,m_item i where t1.id=t2.billno and t2.itemcode=i.id and t1.ledger_id=l.id and t1.vtype in ('sales','sales return')  and (t2.rate<>(select rate from m_rate where item_id=i.group_id order by pdate desc limit 0,1) or t2.rate=0)";
