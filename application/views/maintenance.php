...
//                    $("[tabindex='1']").focus();
            ...
            function GetRpt() {
                ...
                $(".loading").show();
                $.ajax({
                    url: "<?php echo base_url();?>index.php/transactionController/maintenance",
                    type: "GET",
                    data: data,
                    cache: false,
...
//                        $('#from').focus();
            ...
            function ShowPrint(){
                ...
                l_id=$('#party_id').val();
                lname=$('#lname').val();
                window.open($('#baseurl').val()+'index.php/transactionController/ledger_report_print/'+from+'/'+to+'/'+l_id+'/'+lname,'_blank');
            }
            //M-1 :
                function GetParty(){
