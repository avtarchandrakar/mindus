...
<?php
      ...
      if(count($result)>0)
      {
          ...
          echo '            <th style="border-left: 1px solid grey;border-top: 1px solid grey;">Purchase&nbsp;No</th>';
          echo '            <th style="border-left: 1px solid grey;border-top: 1px solid grey;">P.O.No.</th>';
          echo '            <th style="border-left: 1px solid grey;border-top: 1px solid grey;">Jobcard</th>';
          echo '            <th style="border-left: 1px solid grey;border-top: 1px solid grey;">Ref&nbsp;Details</th>';
          echo '            <th style="border-left: 1px solid grey;border-top: 1px solid grey;">Sub&nbsp;Details</th>';
          echo '            <th style="border-left: 1px solid grey;border-top: 1px solid grey;">Total&nbsp;Amt</th>';
          ...
          foreach($result as $row)
          {
                ...
                echo '    <td style="border-left: 1px solid grey;border-top: 1px solid grey;">' . $row->purchase_no.'</td>';
                ...
                echo '    <td style="border-left: 1px solid grey;border-top: 1px solid grey;">' . $row->ref_details.'</td>';
                echo '    <td style="border-left: 1px solid grey;border-top: 1px solid grey;">' . $row->sub_details.'</td>';
                echo '    <td style="border-left: 1px solid grey;border-top: 1px solid grey;" class="dr right">' . number_format($row->tol_freight,2) . '</td>';
          ...
          echo '</tbody>';
            ...
            echo '<tr style="border: 1px solid grey;">';
            echo '<td style="border-top: 1px solid grey;border-left: 1px solid grey;border-bottom: 1px solid grey;" colspan=6>&nbsp;</td>';
            ...
            echo '<td style="border-top: 1px solid grey;border-right: 1px solid grey;border-bottom: 1px solid grey;" colspan=2>&nbsp;</td>';
            echo '</tr>';
          echo '</tfoot>';
          echo '</table>';
      }
