    <div id="data-form">
	    ...
	    <div class="widget-header">
		    <h4 class="widget-title">Party Wise Rate</h4>
	    </div>
		...
		<script type="text/javascript">
		    ...
		    function GetList() {
		        ...
		        $(".loading").show();
		        $.ajax({
		            url: "<?php echo base_url();?>index.php/master_general/item_list_party",
		            type: "GET",
		            data: data,
		            cache: false,
		            success: function (html) {
				        ...
				        $('#newsubmit').click(function () {
				            ...
				            if ($("#userform").valid() == true) {
				                ...
				                $('.loading').show();
				                $.ajax({
				                    url: "<?php echo base_url();?>index.php/master_general/item_party_save",
				                    type: "POST",
				                    data: data,
				                    cache: false,
				                    success: function (html) {
