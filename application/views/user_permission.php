    ...
    <div id="data-form" style="display:none;">
	    ...
	    <div class="widget-header">
		    <h4 class="widget-title">User Permission</h4>
	    </div>
		...
		<div class="form-group">
			...
			<div class="col-sm-3">
			<select tabindex="1" name="permission_id" id="Permission_id" data-rule-required="true"  class="col-xs-10 col-sm-12" onchange="GetList(this);return false;";>
		...
		<script type="text/javascript">
		    ...
		    function GetList(t) {
		    	...
		    	id=$(t).val();
		        data = "list=list"+"&permission_id="+id;
		        if(id>0){
			        $(".loading").show();
			        $.ajax({
			            url: "<?php echo base_url();?>index.php/userController/user_permission_list",
			            type: "GET",
			            data: data,
			            cache: false,
                ...
                }else{ $('#data-list-table').html('');alert('Please Select User Permission !'); }
		    }
		    ...
		    $(document).ready(function () {
		        ...
		        $('#newsubmit').click(function () {
		            ...
		            if ($("#userform").valid() == true) {
		                ...
		                $.ajax({
		                    url: "<?php echo base_url();?>index.php/userController/user_permission_save",
		                    type: "POST",
		                    data: data,
		                    cache: false,
		                    success: function (html) {
