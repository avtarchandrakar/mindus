	...
	<div id="data-form">
		...
		<table id="TblRpt" class="table">
		 ...
		 <tbody id="TblRptBody">
		  <tr>
           <td>
			   <select name="itemcode[]" id="item_id" onchange="GetRate(this);return false;" class="col-xs-10 col-sm-12" tabindex="5">
           ...
           <td style="width:150px;"><input tabindex="6" type="text" name="item_remark[]" id="txt_remark"  class="txt_cls"/></td>
		...
		<label class="col-sm-2 control-label no-padding-right" for="form-field-1"> LR No.</label>
			...
			<div class="col-sm-4">
				<input type="text" tabindex="" name="lr_no" id="lr_no" placeholder="LR No." class="col-xs-11"/><!-- col-xs-10 col-sm-12 -->
			</div>	
		    <label class="col-sm-2 control-label no-padding-right" for="form-field-1"> Transport</label>

			<div class="col-sm-4">
				<input type="text" tabindex="" name="transport" id="transport" placeholder="Transport" class="col-xs-11"/><!-- col-xs-10 col-sm-12 -->
			</div>			
		</div>
		<div class="form-group">
		...
		<div class="form-group">
			...
			<label class="col-sm-2 control-label no-padding-right" for="form-field-1">Paid Build</label>
			<div class="col-sm-4">
				<input type="text" tabindex="" name="paid_build" id="paid_build" placeholder="" class="col-xs-11"/>
			</div>	 
		</div>
