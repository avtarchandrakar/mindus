  <div id="data-list">
    ...
    <div id="data-form" style="display:none;">
	    ...
	    <div class="widget-header">
		    <h4 class="widget-title">Manage Item Brand</h4>
	    </div>
		...
		<script type="text/javascript">
		    ...
		    function GetList() {
		        ...
		        $(".loading").show();
		        $.ajax({
		            url: "<?php echo base_url();?>index.php/master_general/item_company_list",
		            type: "GET",
		            data: data,
		            cache: false,
		    ...
		    function GetRecord(ID) {
		        var url = "<?php echo base_url();?>index.php/master_general/item_company_get?id=" + ID;
