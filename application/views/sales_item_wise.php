...
?>
    ...
    <div id="data-form2" style="display:none;">
        ...
        <div class="widget-header"> 
            <h4 class="widget-title">Sales Item Wise</h4>
        </div>
        ...
        <table class="table">
         <tr>
          ...
          <td style="width:250px;">
                <select name="item_id" id="item_id" class="col-xs-10 col-sm-12" tabindex="3">
...
//                    $("[tabindex='1']").focus();
            ...
            function GetRpt() {
                ...
                item_id=$('#item_id').val();
                data ="from="+from+"&to="+to+"&ledger_id="+ledger_id+"&item_id="+item_id;
                $(".loading").show();
                $.ajax({
                    url: "<?php echo base_url();?>index.php/transactionController/sales_item_wise",
                    type: "GET",
                    data: data,
                    cache: false,
