...
?>
    ...
    <div id="data-form2" style="display:none;">
        ...
        <div class="widget-header"> 
            <h4 class="widget-title">Sales Master Category Wise</h4>
        </div>
...
//                    $("[tabindex='1']").focus();
            ...
            function GetRpt() {
                ...
                $(".loading").show();
                $.ajax({
                    url: "<?php echo base_url();?>index.php/transactionController/sales_mastercategory_wise",
                    type: "GET",
                    data: data,
                    cache: false,
...
//                        $('#from').focus();
            ...
            function GetRptCategory(master_category_id) {
                from=$('#from').val();
                to=$('#to').val();
                ledger_id=$('#ledger_id').val();
                data ="from="+from+"&to="+to+"&ledger_id="+ledger_id+"&master_category_id="+master_category_id;
                $(".loading").show();
                $.ajax({
                    url: "<?php echo base_url();?>index.php/transactionController/sales_category_wise",
                    type: "GET",
                    data: data,
                    cache: false,
                    success: function (html) {
...
//                $('#from').focus();
              ...
              function exportExcel(){
                $("#TblList").table2excel({
                    // exclude CSS class
                    exclude: ".noExl",
                    name: "Sales Master Category Wise",
                    filename:"Sales Master Category Wise"
                  });    
            ...
            function ShowPrint()
            {
                ...
                to=$('#to').val();
                ledger_id=$('#ledger_id').val();
                window.open($('#baseurl').val()+'index.php/transactionController/sale_master_wise_print/'+from+'/'+to+'/'+ledger_id,'_blank');
            }
            </script>
