   <div id="data-list">
    ...
    <div id="data-form" style="display:none;">
	    ...
	    <div class="widget-header">
		    <h4 class="widget-title">Manage Item Category</h4>
	    </div>
		...
		<div class="form-group">
			<label class="col-sm-2 control-label no-padding-right" for="form-field-1"> Group Name</label>

			<div class="col-sm-3">
				<?php
					$query=$this->db->query("select id,name from m_master where type='Master Category' order by name");
					echo "<select id='parent_id' name='parent_id' tabindex='2' class='col-xs-10 col-sm-12' data-placeholder='Select Master Category...''>";
		...
		<script type="text/javascript">
		    ...
		    function GetList() {
		        ...
		        $(".loading").show();
		        $.ajax({
		            url: "<?php echo base_url();?>index.php/master_general/itemcategory_list",
		            type: "GET",
		            data: data,
		            cache: false,
		    ...
		    function GetRecord(ID) {
		        var url = "<?php echo base_url();?>index.php/master_general/itemcategory_get?id=" + ID;
		        $.get(url, function (data) {
		            ...
		            if (report_obj.Message == "Success") {
		                ...
		                $("#prefix").val(report_obj.prefix);
		                $("#vat").val(report_obj.vat);
