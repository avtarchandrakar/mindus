		...
		<table id="TblRpt" class="table">
		 ...
		 <tbody id="TblRptBody">
		  <tr>
           ...
           <td style="width:150px;"><input  type="text" name="drawing_no[]" id="drawing_no"  class="txt_cls" placeholder="Drawing No."/><input type="hidden" name="moc[]" id="moc"  class="txt_cls" placeholder="MOC"/></td>
           <td style="width:150px;"><input  type="text" name="qtymt[]" placeholder="QTY"  id="txt_qtymt" class="qtymt txt_cls" onblur="GetQtyBag(this);return false;"/><input  type="hidden" name="rate[]" id="txt_rate" class="txt_cls" onblur="CalcAmount(this);return false;"/>
			...
			<td style="width:150px;"><input type="text"  placeholder="UOM" name="unit[]" id="txt_unit"  class="txt_cls"/></td>
...
//		    	addLoading();
		        ...
		        $(".loading").show();
		        $.ajax({
		            url: "<?php echo base_url();?>index.php/transactionController/req_get_item",
		            type: "GET",
...
//		    	$(".cdate").mask("99-99-9999");
           ...
           //      });
		    ...
		    {                  
		      ...
		      //  var rowCount = $('#TblRpt tbody tr').length;		        
                ...
                if ($('#userform').validationEngine('validate')) 
                {
                    ...
                    var target="<?php echo base_url();?>index.php/transactionController/requisition_save/tbl_trans1/id";
                    $('#userform').ajaxSubmit({url:target,
                            ...
                            success: function (html) 
                            {
		                        ...
		                        if (html > 0) 
		                        {
									...
									if(r==true)
									{
						                window.open("<?php echo base_url();?>index.php/transactionController/requisition_bill_print/"+html,'_blank');
									}	
		                            if (status.val() == "edit") {
		    ...
		    function GetPreviousRecord(ID) {
		    	// alert(ID);
		        var url = "<?php echo base_url();?>index.php/transactionController/requisition_get?id=" + ID;
		        $.get(url, function (data) {
		            // console.log(data);
...
//	            	}
			  ...
			  function ItemAddNew(currentRow){
			  	 ...
			  	 // console.log(new_row.cells.length);
			  	 var lastrow=x.rows.length-1;
			  	 var ti=0;
