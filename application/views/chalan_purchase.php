   ...
   <div id="data-list" >
    ...
    <div id="data-form" style="display:none;">
		...
		<table id="TblRpt" class="table">
		 ...
		 <tbody id="TblRptBody">
		  <tr>
           ...
           <td style="width:150px;"><input type="hidden" name="rate[]" id="txt_rate" class="txt_cls" onblur="CalcAmount(this);return false;"/></td>
           <td style="width:150px;"><input  type="hidden" name="freight[]" id="txt_freight" class="freight txt_cls" readonly="true" onblur="TolFreight();" /></td>
           <td><button tabindex="7" type="button" id="btn_add" class="btn btn-xs btn-info" onclick="ItemAddNew(this);return false;"><i class="ace-icon fa fa-plus bigger-120"></i></button><button type="button" id="btn_add" class="btn btn-xs btn-danger" onclick="deleteRow(this);return false;"><i class="ace-icon fa fa-trash-o bigger-120"></i></button></td>
		  </tr>
		 </tbody>
		 <tfoot>	
		  <tr>
		   ...
		   <th><input type="hidden" id="tol_qtybag" name="tol_qtybag" readonly="true" class="txt_cls" /></th>
		  <!--  <th><b></b></th> -->
		   <th><input type="hidden" id="tol_freight" name="tol_freight" readonly="true" class="txt_cls" /></th>
		   <th>&nbsp;</th>
		  </tr>
		 <!--  <tr>
		   <th>&nbsp;</th>
		...
		<div class="form-group">
			...
			<div class="col-sm-10">
				<input type="text" tabindex="8" name="remark" id="remark" placeholder="Remark" class="col-xs-11"/><!-- col-xs-10 col-sm-12 -->
			</div>			
		</div>
		...
		<script type="text/javascript">
            ...
            function GetFreight(id){
 		    ...
 		    function GetList() {
		        ...
		        $(".loading").show();
		        $.ajax({
		            url: "<?php echo base_url();?>index.php/transactionController/purchase_list",
		            type: "GET",
		    ...
		    function GetItemList(ID) {
		        ...
		        $(".loading").show();
		        $.ajax({
		            url: "<?php echo base_url();?>index.php/transactionController/purchase_get_item_chalan",
		            type: "GET",
...
//		                $('#TblRpt tbody').append(html);
           ...
           //      });
		        ...
		        if(company_id=='' || company_id==0){
                   alert('Unexpected Error ! Login Again .');
		        	...
		        	//  if(rowCount>1){
		                ...
		                $.ajax({
		                    url: "<?php echo base_url();?>index.php/transactionController/purchase_save_old",
		                    type: "POST",
		    ...
		    function GetRecord(ID) {
		        var url = "<?php echo base_url();?>index.php/transactionController/purchase_get?id=" + ID;
		        $.get(url, function (data) {
		            var report_obj = JSON.parse(data);
		            if (report_obj.Message == "Success") {
