    ...
    <div id="data-form2" style="display:none;">
        ...
        <div class="widget-header"> 
            <h4 class="widget-title">Delete All</h4>
        </div>
        ...
        <table class="table">
         <tr>
         <?php if($p_delete==1){?>
          <td><button tabindex="6" type="button" id="btn_show" class="btn btn-primary" onclick="ShowPrint();">DELETE ALL</button></td>
          <?php }?>
         </tr>
        </table>
        </div>
...
//                        $('#from').focus();
            ...
            function ShowPrint(){
                ...
                if(s)
                {
                    $(".loading").show();
                    $.ajax({
                        url: "<?php echo base_url();?>index.php/transactionController/all_del",
                        type: "POST",
                        cache: false,
                        success: function (html) {
                            alert("OK");
