...
?>
    ...
    <div id="data-form2" style="display:none;">
        ...
        <div class="widget-header"> 
            <h4 class="widget-title">Receipt Report</h4>
        </div>
       ...
       <td>
            <select name="mode_id" id="mode_id" class="col-xs-12 col-sm-12" tabindex="3">
...
//                    $("[tabindex='1']").focus();
            ...
            function GetRpt() {
                ...
                to=$('#to').val();
                mode_id=$('#mode_id').val();
                data ="from="+from+"&to="+to+"&mode_id="+mode_id;
                $(".loading").show();
                $.ajax({
                    url: "<?php echo base_url();?>index.php/transactionController/receipt_report",
                    type: "GET",
                    data: data,
                    cache: false,
