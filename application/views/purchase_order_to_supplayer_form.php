	...
	<div id="data-form">
		...
		<div class="form-group">
			...
			<div class="col-sm-3"  style="display:none;">
					<input type="text" tabindex="3" name="ledger_mobno" id="ledger_mobno" class="col-xs-10 col-sm-12" placeholder="Vehicle No." data-rule-required="true"/>
			</div>
		</div>
		<div class="form-group">
			...
			<div class="col-sm-10">
				<input tabindex="3" type="text"  name="ref_details" id="ref_details" autocomplete="off" placeholder="Ref:" class=" col-xs-10 col-sm-12" list="0"/>
			</div>
		</div>
		<div class="form-group">
			...
			<div class="col-sm-10">
				<input tabindex="4" type="text"  name="sub_details" id="sub_details" autocomplete="off" placeholder="Sub:" class=" col-xs-10 col-sm-12" list="0"/>
			</div>
		</div>
		...
		<table id="TblRpt" class="table">
		 ...
		 <tbody id="TblRptBody">
		  <tr>
           <td>
			   <select name="itemcode[]" id="item_id" onchange="GetRate(this);return false;" class="col-xs-10 col-sm-12 chosen-select" tabindex="5">
           ...
           <td style="width:150px;"><input tabindex="6" type="text" placeholder="" name="item_remark[]" id="item_remark" placeholder="Specification" class="txt_cls"/></td>
           ...
           <td style="width:150px;"><input tabindex="8" type="text" name="unit[]" id="txt_unit"  class="txt_cls"/></td>
                    
           <td style="width:150px;"><input tabindex="9" type="text" name="rate[]" id="txt_rate" class="txt_cls" onblur="CalcAmount(this);return false;"/></td>
			<input tabindex="10" type="hidden"  name="discountrs[]" id="txt_discountrs" class="txt_cls" onblur="CalcAmount(this);return false;"/>
			<input tabindex="11" type="hidden" name="discountper[]" id="txt_discountper" class="txt_cls" onblur="CalcAmount(this);return false;"/>
           
           <td style="width:150px;"><input tabindex="12" type="text" name="freight[]" id="txt_freight" class="freight txt_cls" readonly="true" onblur="TolFreight();" /></td>
           <td><button tabindex="13" type="button" id="btn_add" class="btn btn-xs btn-info" onclick="ItemAddNew(this);return false;"><i class="ace-icon fa fa-plus bigger-120"></i></button><button type="button" id="btn_del" class="btn btn-xs btn-danger" onclick="deleteRow(this);return false;"><i class="ace-icon fa fa-trash-o bigger-120"></i></button></td>
		  </tr>
		 </tbody>
		 <tfoot>
		 <tr>
