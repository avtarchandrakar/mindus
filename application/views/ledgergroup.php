    ...
    <div id="data-form" style="display:none;">
	    ...
	    <div class="widget-header">
		    <h4 class="widget-title">Manage Ledger Group</h4>
	    </div>
		...
		<div class="form-group">
			...
			<div class="col-sm-3">
				<select tabindex="2" name="parent_id" id="parent_id" class="col-xs-10 col-sm-12">
				<?
                $query=$this->db->query('select id,name from m_ledger_group');
                if($query->num_rows()>0){
		...
		<script type="text/javascript">
		    ...
		    function GetList() {
		        ...
		        $(".loading").show();
		        $.ajax({
		            url: "<?php echo base_url();?>index.php/master_general/ledgergroup_list",
		            type: "GET",
		            data: data,
		            cache: false,
		    ...
		    $(document).ready(function () {
		        ...
		        $('#newsubmit').click(function () {
		            ...
		            if ($("#userform").valid() == true) {
		                ...
		                $('.loading').show();
		                $.ajax({
		                    url: "<?php echo base_url();?>index.php/master_general/ledgergroup_save",
		                    type: "POST",
		                    data: data+ "&type=R",
		                    cache: false,
		                    success: function (html) {
		    ...
		    function GetRecord(ID) {
		        var url = "<?php echo base_url();?>index.php/master_general/ledgergroup_get?id=" + ID;
		    ...
		    function DeleteRecord(ID) {
		        ...
		        if (r == true) {
		            $('.loading').show();
		                $.ajax({
		                    url: "<?php echo base_url();?>index.php/helperController/delete/m_ledger_group/id",
		                    type: "POST",
		                    data: {ID: ID},
		                    cache: false,
		                    success: function (html) {
