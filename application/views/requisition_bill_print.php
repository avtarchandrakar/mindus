        ...
        <table border="0" style="width:100%;font-family:verdana">
          <tr>
            <td style="width:100%;" >
              <table border="0" style="width:100%;" cellpadding="0" cellspacing="0">
                <tr>
                  <td style="width:50%;text-align:left;font-size:13px;font-weight: bold;">
                     <?php echo $partyname;?>
                  </td>
          ...
          <tr>
            <td style="width:100%;">
              <table style="width:100%;" cellpadding="0" cellspacing="0">
                <thead>
                <tr>
                  <th style="border-top:1px solid black;border-left:1px solid black;border-left:1px solid black;border-bottom:1px solid black;width:5%;text-align:center;font-size:13px;">
                    Sr. No.
                  </th>
                  <th style="border-top:1px solid black;border-left:1px solid;border-bottom:1px solid black;width:10%;text-align:center;font-size:13px;">
                    Item
                  </th>
                  ...
                  <th style="border-top:1px solid black;border-bottom:1px solid black;border-left:1px solid;width:10%;text-align:center;font-size:13px;">
                    MOC
                  </th>
                  <th style="border-top:1px solid black;border-bottom:1px solid black;border-left:1px solid;width:10%;text-align:center;font-size:13px;border-right:1px solid black;">
                    Quantity
                  </th>
                </tr>
                </thead>
                <? 
                  ...
                  {?>
                    <tr>
                      <td style="width:5%;text-align:left;font-size:13px;padding:5px;border-left:1px solid black;">
                        <?php echo $i+1;?>
                      </td>
                      <td style="border-left:1px solid;width:10%;text-align:left;font-size:13px;padding:5px;">
                      ...
                      <td style="border-left:1px solid;width:10%;text-align:center;font-size:13px;padding:5px;border-right:1px solid black;">
                  ...
                  if($i<8)
                  {
                    ...
                    {?>
                      <tr>
                        ...
                        <td style="border-left:1px solid;width:10%;text-align:left;font-size:13px;padding:5px;border-right:1px solid black;">
                          &nbsp;
                        </td>
                      </tr>
                    <?}
                ...
                <tr style="margin-top: 40px;">
                  <td colspan="3" style="border-top:1px solid;width:50%;text-align:left;padding:5px;font-size:13px;margin-top: 40px;">
                ...
                <tr>
                  <td colspan="3" style="width:50%;text-align:left;padding:5px;font-size:13px;">
