    ...
    <div id="data-form" style="display:none;">
	    ...
	    <div class="widget-header">
		    <h4 class="widget-title">Manage Destination</h4>
	    </div>
		...
		<div class="form-group">
			...
			<label class="col-sm-2 control-label no-padding-right" for="form-field-1"> Freight(PMT)</label>

			<div class="col-sm-3">
				<input tabindex="2" type="text"  name="freight" id="freight" data-rule-required="true" placeholder="Freight(PMT)" class="col-xs-10 col-sm-12" />
			</div>
		</div>
		...
		<script type="text/javascript">
		    ...
		    function GetList() {
		        ...
		        $(".loading").show();
		        $.ajax({
		            url: "<?php echo base_url();?>index.php/master_general/destination_list",
		            type: "GET",
		            data: data,
		            cache: false,
		    ...
		    function GetRecord(ID) {
		        var url = "<?php echo base_url();?>index.php/master_general/destination_get?id=" + ID;
