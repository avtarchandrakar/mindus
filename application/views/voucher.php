   ...
   <div id="data-list">
		...
		<script type="text/javascript">
		    function ShowForm() {
		        ...
		        $.ajax({
		            url: "<?php echo base_url();?>index.php/formController/voucher_form",
		            type: "GET",
		            cache: false,
...
//		    	CheckForm($('#orderno').val());
 		    ...
 		    function GetList() {
		        ...
		        $(".loading").show();
		        $.ajax({
		            url: "<?php echo base_url();?>index.php/transactionController/voucher_list",
		            type: "GET",
...
//				    	$('.cdate').val(getCurDate());
		...
		function GetReport(ID) {
              window.open("<?php echo base_url();?>index.php/transactionController/voucher_print/"+ID,'_blank');
        }
