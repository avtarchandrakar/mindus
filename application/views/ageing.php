    ...
    <div id="data-form2" style="display:none;">
        ...
        <table class="table">
         <tr>
          ...
          <td>District</td>
          <td>
                <select name="district" id="district" class="col-xs-10 col-sm-12" tabindex="2">
...
//                    $("[tabindex='1']").focus();
            ...
            function GetRpt() {
                ...
                data ="to="+to+"&district="+district;
                $(".loading").show();
                $.ajax({
                    url: "<?php echo base_url();?>index.php/transactionController/ageing",
                    type: "GET",
                    data: data,
                    cache: false,
...
//                        $('#to').focus();
            ...
            function ShowPrint(){
                to=$('#to').val();
                district=$('#district').val();
                window.open($('#baseurl').val()+'index.php/transactionController/ageing_print/'+to+'/'+district,'_blank');
            }
            //M-1 :
                function GetParty(){
