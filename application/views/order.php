    ...
    <div id="data-form" style="display:none;">
		...
		<div class="form-group">
		 ...
		 <tbody id="TblRptBody">
		  <tr>
           <td>
			   <select name="itemcode[]" id="item_id" onchange="GetRate(this);return false;" class="col-xs-10 col-sm-12" tabindex="4">
           ...
           <td style="width:150px;"><input tabindex="5" type="text" name="item_remark[]" id="txt_remark"  class="txt_cls"/></td>
           ...
           <td style="width:150px;"><input tabindex="7" type="hidden" name="rate[]" id="txt_rate" class="txt_cls" onblur="CalcAmount(this);return false;"/><input  type="hidden" name="discountrs[]" id="txt_discountrs" class="txt_cls" onblur="CalcAmount(this);return false;"/><input  type="text" name="discountper[]" id="txt_discountper" class="txt_cls" onblur="CalcAmount(this);return false;"/></td>
           ...
           <td><button tabindex="9" type="button" id="btn_add" class="btn btn-xs btn-info" onclick="ItemAddNew(this);return false;"><i class="ace-icon fa fa-plus bigger-120"></i></button><button type="button" id="btn_del" class="btn btn-xs btn-danger" onclick="deleteRow(this);return false;"><i class="ace-icon fa fa-trash-o bigger-120"></i></button></td>
		  </tr>
		 </tbody>
		 <tfoot>			  
		  <tr>
...
//		                $('#TblRpt tbody').append(html);
           ...
           //      });
				...
				$("#txt_freight").keydown(function (event) {
				    if (event.which === 13) {
						FinalCalculation();				    	
				    }
				});
