...
<?php
      ...
      if(count($result)>0)
      {
          ...
          echo '            <th style="border-left: 1px solid grey;border-top: 1px solid grey;">Requisition</th>';
          ...
          foreach($result as $row)
          {
                ...
                echo '    <td style="border-left: 1px solid grey;border-top: 1px solid grey;">' . $row->requisition.'</td>';
          ...
          echo '</tbody>';
            ...
            echo '<tr style="border: 1px solid grey;">';
            echo '<td style="border-top: 1px solid grey;border-right: 1px solid grey;border-left: 1px solid grey;border-bottom: 1px solid grey;" colspan=7>&nbsp;</td>';
            echo '</tr>';
          echo '</tfoot>';
          echo '</table>';
      }
