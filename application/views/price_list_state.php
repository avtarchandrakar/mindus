  ...
  function hidebtn() {
		    ...
		    function GetList() {
		        ...
		        addLoading();
		        $.ajax({
		            url: "<?php echo base_url();?>index.php/master_general/price_list_state_wise",
		            type: "GET",
		            data: data,
		            cache: false,
		            success: function (html) {
				        ...
				        $('#newsubmit').click(function () {
				                ...
				                $('.loading').show();
				                $.ajax({
				                    url: "<?php echo base_url();?>index.php/master_general/price_list_save",
				                    type: "POST",
				                    data: data,
				                    cache: false,
				                    success: function (html) {
		    ...
		    function GetListDate(pdate) {
		    	if(pdate=="")
		    	{
			        data = "pdate="+$("#date").val() + "&cat_id="+$("#cat_id").val()+"&state_id="+$("#state_id").val();
		    	}
		    	else
		    	{
			        data = "pdate="+pdate + "&cat_id="+$("#cat_id").val()+"&state_id="+$("#state_id").val();
		    	}
		        $(".loading").show();
		        addLoading();
		        $.ajax({
		            url: "<?php echo base_url();?>index.php/master_general/price_list_state_date_wise",
		            type: "GET",
		            data: data,
		            cache: false,
		            success: function (html) {
				        ...
				        $('#newsubmit').click(function () {
				                ...
				                $.ajax({
				                    ...
				                    success: function (html) {
				                        $('.loading').hide();
				                        $("#item-list").html("");
				                        $('#state_id option:selected').next().attr('selected', 'selected');
				                        GetListDate(pdate);
				                    }
				                });
				                return false;
