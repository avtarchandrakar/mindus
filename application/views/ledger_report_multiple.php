    ...
    <div id="data-form2" style="display:none;">
        ...
        <div class="form-group">
            ...
            <div class="col-sm-12 multi_inst">
                     ...
                     <? $query=$this->db->query('select id,name from m_ledger order by name'); ?>
                     <? if($query->num_rows()>0){ ?>
...
//                        $('#from').focus();
            ...
            function ShowPrint(){
                ...
                report_type=$('#report_type').val();
                clear_date=$('#clear_date').val();
                window.open($('#baseurl').val()+'index.php/transactionController/lm001/'+from+'/'+to+'/'+l_id+'/'+report_type+'/'+clear_date,'_blank');
            }
            //M-1 :
                function GetParty(){
