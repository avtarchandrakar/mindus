    ...
    <div id="data-form" style="display:none;">
		...
		<table id="TblRpt" class="table" style="margin-bottom:0px;border:0px;width:540px;">
		 ...
		 <tbody id="TblRptBody">
		  <tr>
           ...
           <td style="border:0px;"><input tabindex="6" type="text" id="txt_qtymt" class="txt_cls"/>
		...
		<script type="text/javascript">
		    ...
		    function GetItemList(ID) {
		        ...
		        $(".loading").show();
		        $.ajax({
		            url: "<?php echo base_url();?>index.php/transactionController/sales_return_get_item_chalan",
		            type: "GET",
...
//		                $('#TblRpt tbody').append(html);
           ...
           //      });
		                ...
		                $.ajax({
		                    ...
		                    success: function (html) {
		                        ...
		                        if (html > 0) {
									...
									if(r==true)
									{
						                window.open("<?php echo base_url();?>index.php/transactionController/sales_return_print/"+html,'_blank');
									}	
		    ...
		    function GetReport(ID) {
	            window.open("<?php echo base_url();?>index.php/transactionController/sales_return_print/"+ID,'_blank');
		    }
