<?php
	//List :
	// 	Function : transactionController/order_adjustment_list

	//Save :
	// 	Function : transactionController/order_adjustment_save
	...
	<div class="modal-dialog" style="width:700px;">
		<div class="modal-content">
				<div class="modal-header">
					...
					<h4 class="modal-title">ORDER ADJUSTMENT</h4>
				</div>
				<div class="modal-body">
					...
					<div class="box-content nopadding vehicle-content" style="text-align:center;">
		                ...
		                <div class="controls">                
					        <button type="button" class="btn btn-primary" id="btn_order_adjustment">SAVE</button>
		                 </div>
					</div>
				</div>
		</div>
    ...
    <div id="data-list">
		...
		<div class="form-group">
			...
			<div class="col-sm-12" style="margin-top:20px;">
				...
				<div style="float:right;display:none;" id="adj">
				    <button class="btn btn-xs btn-primary adjselected" onclick="AdjSelected();return false;">
					    Adjust
				    </button>
				</div>
    ...
    <div id="data-form" style="display:none;">
		...
		<script type="text/javascript">
		    ...
		    function GetList() {
		        ...
		        $(".loading").show();
		        $.ajax({
		            url: "<?php echo base_url();?>index.php/transactionController/order_adjustment_list",
		            type: "GET",
		            data: data,
		            cache: false,
...
//						StartTime();						
		    ...
		    $(document).ready(function () {
    			...
    			//////////////////
    			$("#btn_order_adjustment").click(function(){
			        v_id=$('#v_id').val();
			        v_qty=$('#v_qty').val();
		            var data = "id=" + v_id+"&qty="+v_qty;
		            $('.loading').show();
		            $.ajax({
			            url: "<?php echo base_url();?>index.php/transactionController/order_adjustment_save",
		                type: "POST",
		                data: data,
		                dataType: "html",
		                cache: false,
		    ...
		    function OrderAdjustment(id,pending_qty)
		    {
		         $.ajax({
		                url: "<?php echo base_url();?>index.php/transactionController/getsingleorderdetail?id="+id+"&pqty="+pending_qty,
		                type: "GET",
		                cache: false,
		                success: function (html) {
		    ...
		    function AdjSelected() {
		        ...
		        $(".loading").show();
		        $.ajax({
		            url: "<?php echo base_url();?>index.php/transactionController/order_adjustment_save_bulk",
		            type: "POST",
		            data: data,
		            cache: false,
		            success: function (html) {
