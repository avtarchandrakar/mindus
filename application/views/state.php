    ...
    <div id="data-form" style="display:none;">
	    ...
	    <div class="widget-header">
		    <h4 class="widget-title">State Master</h4>
	    </div>
		...
		<script type="text/javascript">
		    ...
		    function GetList() {
		        ...
		        $(".loading").show();
		        $.ajax({
		            url: "<?php echo base_url();?>index.php/master_general/state_list",
		            type: "GET",
		            data: data,
		            cache: false,
		    ...
		    function GetRecord(ID) {
		        var url = "<?php echo base_url();?>index.php/master_general/state_get?id=" + ID;
