   ...
   .modal-dialog{
	...
	<div id="data-form">
		...
		<div class="form-group">
			...
			<div class="col-sm-3">
				<input tabindex="3" type="text"  name="lname" id="lname" autocomplete="off" placeholder="Ledger Name" class="ledgerinfo col-xs-10 col-sm-12" list="0" onkeyup="GetParty();return false;" /><input type="hidden" id="ledger_id" name="ledger_id">			     
			</div>
			<label class="col-sm-2 control-label no-padding-right" for="form-field-1"> Vehicle No</label>			
			<div class="col-sm-3">
					<input type="text" tabindex="4" name="ledger_mobno" id="ledger_mobno" class="col-xs-10 col-sm-12" placeholder="Vehicle No." />
			</div>
		</div>

		<div class="form-group">
			<label class="col-sm-2 control-label no-padding-right" for="form-field-1"> Item Type</label>

			<div class="col-sm-3">
			    <select name="item_type" id="item_type" class="col-xs-10 col-sm-12" tabindex="5">
		...
		<table id="TblRpt" class="table">
		 ...
		 <tbody id="TblRptBody">
		  <tr>
           <td >
			    <select name="itemcode[]" id="item_id" onchange="GetRate(this);return false;" class="col-xs-10 col-sm-12" tabindex="6">
...
<input type="hidden" id="order_id" name="orderid_gen[]"/>
           ...
           <td style="width:150px;"><input tabindex="7" type="text" name="qtymt[]" id="txt_qtymt" class="qtymt txt_cls" onblur="GetQtyBag(this);return false;"/></td>
                    
           <td style="width:150px;"><input tabindex="8" type="text" name="rate[]" id="txt_rate" class="txt_cls" onblur="CalcAmount(this);return false;"/></td>
           ...
           <td style="width:150px;"><input tabindex="9" type="text" name="discountrs[]" id="txt_discountrs" class="txt_cls" onblur="CalcAmount(this);return false;"/></td>
			...
			<td style="width:150px;"><input tabindex="10" type="text" name="discountper[]" id="txt_discountper" class="txt_cls" onblur="CalcAmount(this);return false;"/></td>
           



           <td style="width:150px;"><input tabindex="11" type="text" name="freight[]" id="txt_freight" class="freight txt_cls" readonly="true" onblur="TolFreight();" /></td>
           <td><button tabindex="12" type="button" id="btn_add" class="btn btn-xs btn-info" onclick="ItemAddNew(this);return false;"><i class="ace-icon fa fa-plus bigger-120"></i></button><button type="button" id="btn_del" class="btn btn-xs btn-danger" onclick="deleteRow(this);return false;"><i class="ace-icon fa fa-trash-o bigger-120"></i></button></td>
		  </tr>
		 </tbody>
		 <tfoot>	
		  <tr>
		   ...
		   <th>Freight</th>
		  <!--  <th><b></b></th> -->
		   <th><input type="text" id="lr_freight" name="lr_freight" class="txt_cls" onblur="TolFreight();" onkeyup="TolFreight();" /></th>
		   <th>&nbsp;</th>
		  </tr>
		  <tr>
		   <th>&nbsp;</th>
		  ...
		  <tr>
		   ...
		   <th>F1 Amount</th>
		  <!--  <th><b></b></th> -->
		   <th><input type="text" id="f1_amount" name="f1_amount" class="txt_cls" /></th>
		   <th>&nbsp;</th>
		  </tr>
		  ...
		  <tr>
		   ...
		   <th>F2 Amount</th>
		  <!--  <th><b></b></th> -->
		   <th><input type="text" id="f2_amount" name="f2_amount" class="txt_cls" /></th>
		   <th>&nbsp;</th>
		  </tr>
		 <!--  <tr>
		   <th>&nbsp;</th>
		...
		<label class="col-sm-2 control-label no-padding-right" for="form-field-1"> Loading Person Name</label>
			...
			<div class="col-sm-4">
				<input type="text" tabindex="" name="loading_person_name" id="loading_person_name" placeholder="Loading Person Name" class="col-xs-11"/><!-- col-xs-10 col-sm-12 -->
			</div>	
		    <label class="col-sm-2 control-label no-padding-right" for="form-field-1"> Remark</label>

			<div class="col-sm-4">
				<input type="text" tabindex="13" name="remark" id="remark" placeholder="Remark" class="col-xs-11"/><!-- col-xs-10 col-sm-12 -->
			</div>			
		</div>
		<div class="form-group">
			<label class="col-sm-2 control-label no-padding-right" for="form-field-1">Checked By</label>
			<div class="col-sm-4">
				<input type="text" tabindex="" name="checked_by" id="checked_by" placeholder="Checked By" class="col-xs-11"/>
			</div>	
		    <label class="col-sm-2 control-label no-padding-right" for="form-field-1"> Transport Narration</label>

			<div class="col-sm-4">
				<input type="text" tabindex="" name="transport_narration" id="transport_narration" placeholder="Transport Narration" class="col-xs-11"/><!-- col-xs-10 col-sm-12 -->
			</div>			
		</div>
		<div class="form-group">
			<label class="col-sm-2 control-label no-padding-right" for="form-field-1">Dispatch Through</label>
			<div class="col-sm-4">
				<input type="text" tabindex="" name="dispatch_through" id="dispatch_through" placeholder="Dispatch Through" class="col-xs-11"/>
			</div>	 
		</div>
		...
		<div class="clearfix form-actions">
			<div class="col-md-offset-3 col-md-9">
				<button  tabindex="14" class="btn btn-info" type="button" id="newsubmit" >
...
//		    	addLoading();
		        ...
		        $(".loading").show();
		        $.ajax({
		            url: "<?php echo base_url();?>index.php/transactionController/sales_return_get_item",
		            type: "GET",
...
//		    	$(".cdate").mask("99-99-9999");
           ...
           //      });
		        ...
		        if(company_id=='' || company_id==0){
                   alert('Unexpected Error ! Login Again .');
		        	...
		        	//  if(rowCount>1){
		                ...
		                $.ajax({
		                    url: "<?php echo base_url();?>index.php/transactionController/sales_return_save",
		                    type: "POST",
		                    data: data,
		                    cache: false,
		                    success: function (html) {
		                        ...
		                        if (html > 0) {
									...
									if(r==true)
									{
						                window.open("<?php echo base_url();?>index.php/transactionController/sales_ret_bill_print/"+html,'_blank');
									}	
		                            if (status.val() == "edit") {
		    ...
		    function GetPreviousRecord(ID) {
		        var url = "<?php echo base_url();?>index.php/transactionController/sales_return_get?id=" + ID;
		        $.get(url, function (data) {
		            var report_obj = JSON.parse(data);
		            if (report_obj.Message == "Success") {
...
//		    	addLoading();
				...
				cdate=$('#cdate').val();
		        var url = "<?php echo base_url();?>index.php/master_general/party_rate_get_single?item_id="+item_id+"&cdate="+cdate;
				$.ajax({
					url : url,
					type:"get",
					async:false,
...
//			        	clearLoading();
	      ...
	      //      }
		      ...
		      function TolFreight(){
			    ...
			    sum=sum.toFixed(2);
			    console.log("sum : " +parseFloat(sum,2));
