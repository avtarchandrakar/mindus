   ...
   .modal-dialog{
	...
	<div id="data-form">
		...
		<div class="form-group">
			<label class="col-sm-2 control-label no-padding-right" for="form-field-1"> Mail Subject</label>

			<div class="col-sm-9">
				<input  type="text" name="subject" id="subject" autocomplete="off" placeholder="Mail Subject" value="<?=$subject?>" class="ledgerinfo col-xs-10 col-sm-12" list="0" />
			</div>
		</div>
		<div class="form-group">
			...
			<div class="col-sm-9" >
					<textarea type="text"  name="mailbody" id="mailbody" class="col-xs-10 col-sm-12" placeholder="Remark" rows="6" data-rule-required="true"><?=$mailbody?></textarea>
			</div>
		</div>
...
//		                $('#TblRpt tbody').append(html);
		    ...
		    {    
                ...
                if ($('#userform').validationEngine('validate')) 
                {
                    ...
                    var target="<?php echo base_url();?>index.php/transactionController/workorder_mail";
