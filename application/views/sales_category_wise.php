...
?>
    ...
    <div id="data-form2" style="display:none;">
        ...
        <div class="widget-header"> 
            <h4 class="widget-title">Sales Category Wise</h4>
        </div>
...
//                        $('#from').focus();
            ...
            function ShowPrint(){
                ...
                to=$('#to').val();
                ledger_id=$('#ledger_id').val();
                window.open($('#baseurl').val()+'index.php/transactionController/sale_category_wise_print/'+from+'/'+to+'/'+ledger_id,'_blank');
            }
            //M-1 :
                function GetParty(){
