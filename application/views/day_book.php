...
?>
    ...
    <div id="data-form2" style="display:none;">
        ...
        <div class="widget-header"> 
            <h4 class="widget-title">Day Book</h4>
        </div>
...
//                    $("[tabindex='1']").focus();
            ...
            function GetRpt() {
                ...
                $.ajax({
                    url: "<?php echo base_url();?>index.php/transactionController/day_book",
                    type: "GET",
                    data: data, 
                    cache: false,
...
//                        $('#from').select();
            ...
            function ShowPrint(){
                from=$('#from').val();
                to=$('#to').val();
                window.open($('#baseurl').val()+'index.php/transactionController/day_book_print/'+from,'_blank');
            }
            //M-1 :
                function GetParty(){
