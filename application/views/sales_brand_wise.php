...
?>
    ...
    <div id="data-form2" style="display:none;">
        ...
        <div class="widget-header"> 
            <h4 class="widget-title">Sales Brand Wise</h4>
        </div>
        ...
        <table class="table">
         <tr>
          <td>From</td><td><input tabindex="1" type="text"  name="from" id="from" placeholder="From" value="<?echo $cdate;?>" class="cdate col-xs-6 col-sm-6" list="0"/></td>
          <td>To</td><td><input tabindex="2" type="text"  name="to" id="to" placeholder="To" value="<?echo $cdate;?>" class="cdate col-xs-6 col-sm-6" list="0"/></td>
          <td>State</td>
          <td>
                <select name="state_id" id="state_id" class="col-xs-10 col-sm-12" tabindex="3">
...
//                    $("[tabindex='1']").focus();
            ...
            function GetRpt() {
                ...
                if(type==0)
                {
                    var url="<?php echo base_url();?>index.php/transactionController/sales_brand_wise";
                }
                if(type==1)
                {
                    var url="<?php echo base_url();?>index.php/transactionController/sales_brand_wise_1";
                }
                if(type==2)
                {
                    var url="<?php echo base_url();?>index.php/transactionController/sales_brand_wise_2";
                }
                data ="from="+from+"&to="+to+"&state_id="+state_id+"&ledger_id="+ledger_id+"&type="+type;
                $(".loading").show();
                $.ajax({
                    url: url,
                    type: "GET",
...
//                        $('#from').focus();
            ...
            function ShowPrint(){
                ...
                if(type==0)
                {
                    var url="sale_brand_wise_print";
                }
                if(type==1)
                {
                    var url="sale_brand_wise_print_1";
                }
                if(type==2)
                {
                    var url="sale_brand_wise_print_2";
                }
                window.open($('#baseurl').val()+'index.php/transactionController/'+url+'/'+from+'/'+to+'/'+ledger_id+'/'+state_id,'_blank');
            }
            //M-1 :
                function GetParty(){
...
//                $('#from').focus();
              ...
              function exportExcel(){
                $("#TblList").table2excel({
                    // exclude CSS class
                    exclude: ".noExl",
                    name: "Sales Brand Wise",
                    filename:"Sales Brand Wise"
                  });    
