    ...
    <div id="data-form2" style="display:none;">
        ...
        <table class="table">
         <tr>
          ...
          <td>State</td>
          <td>
                <select name="state" id="state" class="col-xs-10 col-sm-12" tabindex="2">
                     <option value=" ">Select State</option>
                     <? $query=$this->db->query('select name from m_master where company_id='.get_cookie('ae_company_id').' and type="State" order by name'); ?>           
                     <? if($query->num_rows()>0){ ?>
...
//                    $("[tabindex='1']").focus();
            ...
            function GetRpt() {
                ...
                data ="to="+to+"&state="+state+"&group_id="+group_id;
                $(".loading").show();
                $.ajax({
                    url: "<?php echo base_url();?>index.php/transactionController/ageing_state",
                    type: "GET",
                    data: data,
                    cache: false,
...
//                        $('#to').focus();
            ...
            function ShowPrint(){
                to=$('#to').val();
                state=$('#state').val();
                window.open($('#baseurl').val()+'index.php/transactionController/ageing_state_print/'+to+'/'+state,'_blank');
            }
            //M-1 :
                function GetParty(){
