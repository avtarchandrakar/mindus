...
?>
    ...
    <div id="data-form2" style="display:none;">
        ...
        <div class="widget-header"> 
            <h4 class="widget-title">Salesman Summary</h4>
        </div>
        ...
        <table class="table">
         <tr>
          <td style="width:50px;">Upto</td><td><input tabindex="1" type="text"  name="to" id="to" placeholder="To" value="<?echo $cdate;?>" class="cdate col-xs-6 col-sm-6" list="0"/></td>
          <td style="width:100px;">Line Group</td>
          <td style="width:300px;">
                <?php
                  $query=$this->db->query("select id,name from m_master where type='Salesman' order by name");
                  echo "<select id='line_id' name='line_id' tabindex='2' class='col-xs-10 col-sm-12' data-placeholder='Select Salesman Name...''>";
...
//                    $("[tabindex='1']").focus();
            ...
            function GetRpt() {
                ...
                $(".loading").show();
                $.ajax({
                    url: "<?php echo base_url();?>index.php/transactionController/salesman_wise_summary",
                    type: "GET",
                    data: data,
                    cache: false,
...
//                        $('#to').focus();
            ...
            function ShowPrint(){
                to=$('#to').val();
                line_id=$('#line_id').val();
                window.open($('#baseurl').val()+'index.php/transactionController/salesman_wise_print/'+to+'/'+line_id,'_blank');
            }
            //M-1 :
                function GetParty(){
