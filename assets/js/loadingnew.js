...
var urlstr = $("#baseurl").val();
var imgUrl = urlstr + 'assets/img/Icon-Search-loader.gif';
...
function addLoading(modalId) {
    ...
    if (modalId === undefined || modalId == null) {
        ...
        $backdrop = $('<div><div class="modal-backdrop"></div><div class="modal" style="display:inline;position:fixed;left:50%;top:50%;"><img src="'
        ...
        $backdrop = $('<div onclick="clearLoading()"><div class="modal-backdrop" ' + cover + '></div><div class="modal" '
                                    + modal + '><img src="' + imgUrl + '" alt="" title="" /></div></div>').appendTo(p);
    }
}
